...
public class Multiplication_CalculatorTest {
    ...
    public void testMultiplication() throws Exception{
        ...
        Utils.captureScreenshot(screenshotPath,"testMultiplication");
        System.out.println("DemoWebShop Login Screenshot is captured for testMultiplication");
    }
