...
public class Division_CalcualtorTest {
    ...
    public void testDivision() throws Exception{
        ...
        Utils.captureScreenshot(screenshotPath,"testDivision");
        System.out.println("DemoWebShop Login Screenshot is captured for testDivision");
    }
